...
//        
//        self.birthRate = defaults.object(forKey: "FogBirthRate") as? CGFloat ?? 0.01
//        self.scale = defaults.object(forKey: "FogScale") as? CGFloat ?? 0.7
//        self.scaleRange = defaults.object(forKey: "FogScaleRange") as? CGFloat ?? 0.2
//        self.speed = defaults.object(forKey: "FogSpeed") as? CGFloat ?? 100
//        self.speedRange = defaults.object(forKey: "FogSpeedRange") as? CGFloat ?? 60
...
//        self.bgOpacity = defaults.object(forKey: "FogBgOpacity") as? CGFloat ?? 0.25
