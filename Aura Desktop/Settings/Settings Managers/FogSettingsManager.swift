...
class FogSettingsManager: ObservableObject, WeatherSettings {
    ...
    init() {
        ...
        self.birthRate = defaults.object(forKey: "FogBirthRate") as? CGFloat ?? 100
        self.scale = defaults.object(forKey: "FogScale") as? CGFloat ?? 1
        self.scaleRange = defaults.object(forKey: "FogScaleRange") as? CGFloat ?? 0.25
        self.speed = defaults.object(forKey: "FogSpeed") as? CGFloat ?? 630
        self.speedRange = defaults.object(forKey: "FogSpeedRange") as? CGFloat ?? 90
        self.angle = defaults.object(forKey: "FogAngle") as? CGFloat ?? 0
        self.angleRange = defaults.object(forKey: "FogAngleRange") as? CGFloat ?? .pi / 32
        ...
        self.bgOpacity = defaults.object(forKey: "FogBgOpacity") as? CGFloat ?? 0.2
        self.bgColor = defaults.object(forKey: "FogBgColor") as? Color ?? Color.black
        self.direction = defaults.object(forKey: "FogDirection") as? CGFloat ?? -1.0
        self.color = defaults.object(forKey: "FogColor") as? NSColor ?? NSColor(red: 139.0/255.0, green: 145.0/255.0, blue: 255.0/255.0, alpha: 1)
